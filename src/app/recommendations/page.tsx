    ...
    <div className="container mx-auto px-4 md:px-6 py-8 animate-slide-in-from-bottom">
        <div className="max-w-3xl mx-auto space-y-8">
            <div className="text-center">
                <h1 className="text-2xl font-bold tracking-tight">AI Event Recommendations</h1>
                <p className="mt-2 text-sm text-muted-foreground">
                    Tell us about your skills, and our AI will find the perfect volunteering opportunities for you.
                </p>
            </div>
